...
- Hero rule: use the supplied waterfront title art edge to edge. Mask the original moon completely, then place the supplied clean striped Mack Rilla portrait as the only visible circle with clear vertical separation above the shoreline wordmark. Every non-logo opening in the upper title field continues the pixel star field; every non-letter opening below GAMEORILLA continues stepped neon water reflections. Stars and the outside cityscape remain the background; no second ring, flat black patch, or circle may remain. Apply the documented white O and place “the ape vice arkade” inside the title picture close beneath GAMEORILLA.
